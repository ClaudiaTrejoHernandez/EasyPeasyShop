...
// add a POST method to add a product to the cart - the url should be
    ...
    public void addToCart(@PathVariable int productId, Principal principal) {
        ...
        try{
            ...
            //Add product to the cart using the ShoppingCartDao
...
// add a PUT method to update an existing product in the cart - the url should be
    ...
    @PreAuthorize("hasAnyRole('USER','ADMIN')")
    @ResponseStatus(HttpStatus.CREATED)
    public void updateCartItemQuantity(@PathVariable int productId,@RequestBody int quantity, Principal principal) {
